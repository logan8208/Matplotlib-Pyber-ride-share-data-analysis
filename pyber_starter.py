...
plt.scatter(suburban_ride_count, 
            suburban_avg_fare, 
            s=15*suburban_driver_count, c="blue", 
            edgecolor="black", linewidths=1, marker="o", 
...
plt.pie(city_type_percents, labels=["Rural", "Suburban", "Urban"], colors=["green","blue", "yellow"], explode=[0,0,0.2], autopct='%1.2f%%', shadow=True, startangle=90)
...
plt.pie(ride_nums, labels=["Urban", "Suburban", "Rural"], autopct='%1.1f%%', colors=["yellow","blue", "green"], shadow=True, startangle=90, explode=[0.2,0,0])
